    ...
    this.state.contract.methods
      ...
      .call((error, val) => {
        try {
          if (error) {
            console.error(error);
            const CheckFileExistErrorMessage =
              "Mr. Stark, I don't feel so good";
            const CheckFileExistErrorType = "Unknown";
            throw new CheckFileExistError(
              CheckFileExistErrorMessage,
              CheckFileExistErrorType
            );
          }
          ...
          if (val[0]) {
            if (val[1] === this.state.activeAccount) {
              ...
              const FileExistErrorMessage =
                "Oops, you've stored this file. This file belongs to: ";
          ...
          <div className="justify-content-between">
            ...
            <div className="px-3 pt-3 d-flex align-items-center justify-content-center">
              <p className="lead text-center">
                Complete the form and upload your file.
                <br />
                <span className="fs-6">
                  ...
                  section will be automatically updated after confirming
                  transaction.
                </span>
              </p>
            </div>
